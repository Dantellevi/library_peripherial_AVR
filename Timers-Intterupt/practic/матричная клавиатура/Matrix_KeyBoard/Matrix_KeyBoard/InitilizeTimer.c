...
unsigned char valInter=0;						//глобальное значение таймера 0
unsigned char valInter2=0;						//глобальное значение таймера 2
unsigned int valInter1=0;						//глобальное значение таймера 1
char valcomp=0;									//переменная хранения для режима CTC timer0
unsigned int valcomp1=0;						//переменная хранения для режима CTC timer1
char valcomp2=0;								//переменная хранения для режима CTC timer2
extern unsigned char valueKeyboard;				//переменная для работы с поролем
extern unsigned char key_code[4][3];			//переменная которая хранит тип матричной клавиатуры
