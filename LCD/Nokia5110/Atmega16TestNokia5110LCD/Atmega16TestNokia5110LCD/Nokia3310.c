 ...
 * Возвращаемое значение :  смотри возвращаемое значение в NOKIA3310.h
 */
 ...
 *                          mode  -> Off, On или Xor. Смотри enum в NOKIA3310.h
 * Возвращаемое значение :  смотри возвращаемое значение в NOKIA3310.h
 */
 ...
 * Имя                   :  Lcd_triangle
 * Описание              :  Рисует незакрашенный прямоугольник
 * Аргумент(ы)           :  x1    -> абсолютная координата первого угла треугольника
 *                          y1    -> абсолютная координата y первого угла треугольника
 *                          x2    -> абсолютная координата x второго угла треугольника
 *                          y2    -> абсолютная координата y второго угла треугольника
							x3    -> абсолютная координата x третьего угла треугольника
 ...
 */
 ...
 Lcd_line(x1,y1,x2,y2,mode);
 Lcd_line(x2,y2,x3,y3,mode);
 Lcd_line(x3,y3,x4,y4,mode);
 Lcd_line(x4,y4,x1,y1,mode);
