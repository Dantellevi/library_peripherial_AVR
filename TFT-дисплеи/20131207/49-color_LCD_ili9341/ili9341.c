...
// define it if you want to use proportional font. Else you'll get monospace
#define PROPORCINIS

#ifdef PROPORCINIS
	#include "levofontas.c"
#else
	#include "font.c"
	#define FONT_SPACE 6
	#define FONT_X 8
...
inline void ili9341_send_byte(uint8_t data)
{
	//ili9341_select_chip();
...
inline unsigned char ili9341_read_byte(void)
{
	ili9341_select_chip();
